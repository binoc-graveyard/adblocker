			...
			case "profile-after-change":
				...
				if (appInfo.ID != "{a23983c0-fd0e-11dc-95ff-0800200c9a66}" && appInfo.ID != "{aa3c5121-dab2-40e2-81ca-7ea25febc110}")
				{
					try
					{
						...
						Cu.import("chrome://@ADDON_CHROME_NAME@-modules/content/Bootstrap.jsm");
					}
					catch (e)
					{
						...
						let bootstrapURL = chromeRegistry.convertChromeURL(ioService.newURI("chrome://@ADDON_CHROME_NAME@-modules/content/Bootstrap.jsm", null, null));
